# patient_diabete_risk_service:ttf3w5d54cdbcnht

[![pypi_status](https://img.shields.io/badge/BentoML-1.0.12-informational)](https://pypi.org/project/BentoML)
...
| ------------ | ----- | ------ |
| POST [`/classify`](#operations-Service_APIs-patient_diabete_risk_service__classify) | JSON | JSON |
